...
class EditActivity : AppCompatActivity() {
    ...
    private fun initData(){
        etNamaUjian.text = (intent.getStringExtra("namaUjian") ?:"") as Editable?
        etKelas.text = (intent.getStringExtra("kelas") ?:"") as Editable?
        etMapel.text = (intent.getStringExtra("mapel") ?:"") as Editable?
        etDurasi.text = (intent.getStringExtra("durasi") ?:"") as Editable?
        etUrl.text = (intent.getStringExtra("url") ?:"") as Editable?
